...
def get_weather_forecast(
    ...
    How this fits the architecture:
    This is reusable weather API behavior. The current CLI agent can keep using
    it, and the future MCP server will be able to expose the same function as a
    tool for LangChain or any other MCP client.
    """
    try:
        days = int(days)
